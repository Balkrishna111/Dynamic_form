...
const {mutate: mutateFormElement} = useMutation({
  ...
  return (
    <form onSubmit={(e)=> {
      ...
      {
        ...formElement,
        id: uuidv4(), // Ensure id is always a string
      },
    ]
    ...
    <div className="w-4/6 ">
        <div>
            ...
            <Input placeholder="label" onChange={(e)=> {setFormElement({...formElement, label : e.target.value})}}/>
        </div>
        <div>
            <Label children={"Data Type"}/>
           <Select onChange={(e) => setFormElement({ ...formElement, type: e })} 
                    options={
                                [
                                    {
                    label: "Text",
    ...
    <div className="my-4">
      ...
      <div className="flex items-center px-4 py-6 bg-gray-200 rounded-lg mb-4">
        ...
        <div>
            ...
            <Input placeholder="placeholder" onChange={e=> setFormElement({...formElement, placeholder: e.target.value})}/>
        </div>
        <div className="my-2">
        ...
        <div>
            ...
            <Input placeholder="Default value" onChange={(e)=> setFormElement({...formElement, value: e.target.value})}/>
        </div>
<button type="submit" className="button border w-full py-1 bg-blue-500 text-white mt-4 rounded-md">Submit</button>
    </div>
    </form>
  )
}
